...
private:
	...
	void RenderScene(RenderTexture*, Camera*, bool, RenderTexture* = nullptr, Texture* = nullptr, Texture* = nullptr, Texture* = nullptr, Texture* = nullptr);
...
private:
	...
	RenderTexture*    m_aboveRefractionAuxiliaryRenderTexture;
